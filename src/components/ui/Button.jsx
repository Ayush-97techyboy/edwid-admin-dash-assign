...
const Button = ({ children, variant = 'primary', size = 'md', className = '', disabled, onClick, type = 'button', fullWidth }) => {
  ...
  const variants = {
    primary: "bg-[#ff8449] text-white hover:bg-[#e6753d] focus:ring-[#ff8449] shadow-sm",
    secondary: "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-[#ff8449] shadow-sm",
    danger: "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 shadow-sm",
    ghost: "bg-transparent text-gray-600 hover:bg-gray-100 focus:ring-gray-500",
    outline: "bg-transparent border border-[#ff8449] text-[#ff8449] hover:bg-orange-50"
  };
